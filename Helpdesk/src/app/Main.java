...
public class Main {
    ...
    public static StatusChamado escolherNivel(Scanner entrada)  {
        System.out.printf("1 - ABERTO | 2 - EM_ANDAMENTO | 3 - RESOLVIDO | 4 - CANCELADO");
        int opcao = entrada.nextInt();
        entrada.nextLine();
    ...
    public static void main(String[] args){
        ...
        do{
            ...
            System.out.println("3 - Alterar Status do Chamado");
            ...
            switch (opcao){
                ...
                case 3: {
                    ...
                    StatusChamado st = escolherNivel(entrada);

                    hd.alterarStatus(numero, st);
